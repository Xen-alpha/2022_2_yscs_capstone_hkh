...
from utils import add_input_layer, module_restriction, inverted_residual_block_max_restriction
...
block_restriction_tool.restrict(robust_model)
...
for layer_num in layer_nums:
    ...
    for images, labels in dataloader:
        ...
        block_restriction_tool.restrict(corrupted_robust_model)
